    ...
    const addProduct = async (e) => {
        ...
        try {
            ...
            if (res.status === 201) {
                ...
                alert("Product is already added with that quantity.");
            }
            else {
    ...
    return (
        <div className='container-fluid p-5'>
            ...
            <div className='d-flex justify-content-center col-lg-6 col-md-6'>
                ...
                <button type="submit" onClick={addProduct} className="btn btn-primary fs-4" disabled={loading}>{loading ? 'Adding...' : 'Add'}</button>
            </div>
